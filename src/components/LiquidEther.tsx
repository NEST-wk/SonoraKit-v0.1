...
`;
        ...
        class ExternalForce extends ShaderPass {
            ...
            private initMouse(simProps: SimPropsBase) {
                super.init();
            ...
            update(options?: { mouse_force?: number; cursor_size?: number; cellScale?: THREE.Vector2 }) {
                const props = options || {};
        ...
        class Viscous extends ShaderPass {
            constructor(simProps: SimPropsBase & { dst_: THREE.WebGLRenderTarget }) {
                super({
                    material: {
                        vertexShader: face_vert,
        ...
        class Pressure extends ShaderPass {
            constructor(simProps: SimPropsBase & { src_p: THREE.WebGLRenderTarget; src_v: THREE.WebGLRenderTarget }) {
                super({
                    material: {
                        vertexShader: face_vert,
